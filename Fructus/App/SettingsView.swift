            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack {
                    ...
                    GroupBox(
                        ...
                        Divider().padding(.vertical, 4)
                        Text("If you wish, you can restart the application by toggle the switch in this box. That way it starts the onboarding process and you will see the welcome screeen again.")
                            .padding(.vertical, 8)
                            .frame(minHeight: 60)
                            .layoutPriority(2)
                            .font(.footnote)
